...
PHONE_FIELD = CharField(
    label='手机号码', required=True, validators=[phone_validator],
    help_text='手机号码', error_messages={'required': '请提供手机号码。'},
)
...
class LoginSerializer(Serializer):
    name = CharField(label='用户名', max_length=20, help_text='用户名', required=True,
